...
var lightPosition = new THREE.Vector3(3.0, 1.2, 3.0);
...
function createScene()
{
    ...
    const cylinder_geometry = new THREE.CylinderGeometry( 0.1, 0.7, 3, 32 );
    const cylinder_material = new THREE.MeshLambertMaterial( {color: 'aquamarine'} );
    ...
    const sphere_material = new THREE.MeshLambertMaterial( { color: 'lightgreen' } );

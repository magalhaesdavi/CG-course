...
function updateConvexObject( )
{
    ...
    var vertex1 = new THREE.Vector3(-3, 0, -3);
    var vertex2 = new THREE.Vector3(-3, 0, 3);
    var vertex3 = new THREE.Vector3(3, 3, -3);
    var vertex4 = new THREE.Vector3(3, 3, 3);

    var vertex5 = new THREE.Vector3(-3, 3, -3);
    var vertex6 = new THREE.Vector3(-3, 3, 3);
    var vertex7 = new THREE.Vector3(8, 0, -3);
    var vertex8 = new THREE.Vector3(8, 0, 3);

    points = [vertex1, vertex2, vertex3, vertex4, vertex5, vertex6, vertex7, vertex8];
